      ...
      <TabGroup onChange={(idx) => setIsSelectTap(idx)}>
        <TabList className="top flex py-[24px] px-[16px] lg:pl-[15px] justify-between items-center self-stretch lg:px-0 lg:pt-[34px]">
          <div className="flex items-center gap-[16px] ld:h-[54px] lg:gap-[4px] lg:rounded-2xl lg:bg-[#F2F2F2] lg:border-[2px] lg:border-black">
            <Tab className="text-[20px] not-italic font-[400] leading-[27px] data-[selected]:text-black text-[#A6A6A6] lg:rounded-xl lg:p-[10px] lg:text-[20px] lg:font-[400] lg:text-[#8C8C8C] lg:data-[selected]:text-white lg:data-[selected]:bg-[#F2693B] lg:data-[selected]:border-[2px] lg:data-[selected]:border-black lg:w-[90px]">
              피드
            </Tab>
            <Tab className="text-[20px] not-italic font-[400] leading-[27px] data-[selected]:text-black text-[#A6A6A6] lg:rounded-xl lg:p-[10px] lg:text-[20px] lg:font-[400] lg:text-[#8C8C8C] lg:data-[selected]:text-white lg:data-[selected]:bg-[#F2693B] lg:data-[selected]:border-[2px] lg:data-[selected]:border-black lg:w-[90px]">
              달력보기
